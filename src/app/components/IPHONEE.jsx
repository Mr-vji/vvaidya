...
export function IPHONEE(props) {
  const { nodes, materials } = useGLTF("./models/videoIphone .glb");
  ...
  // Optional: clamp to prevent repeating
...
useGLTF.preload("./models/videoIphone .glb");
